...
This project is based on the open-source repository from github. It has been modified to demonstrate CI/CD, SAST, secrets scanning, DAST, container security, and other DevSecOps practices.
